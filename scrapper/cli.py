...
from scrapper.pdfs_to_txts import PDF2txt, supported_parsers
...
@click.option(u'--parser-to-use', u'-parser', type=click.Choice(supported_parsers), default='pdftotext',
